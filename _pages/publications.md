...
[C1] **Kim, Y.-G.**, Hu, M.-C., Nunes, E. V., Luo, S. X.‡, and Liu, Y.‡ (2025). Optimizing contingency management with reinforcement learning. *IEEE International Conference on Healthcare Informatics*. Selected as a long presentation [[Paper]](https://www.computer.org/csdl/proceedings-article/ichi/2025/209400a379/28yCzctfQYg) [[Code]](https://github.com/kyg0910/Optimizing-Contingency-Management-with-Reinforcement-Learning)
   ‡: Equal contribution of the corresponding authors

[C2] Yu, W., Qu, G., **Kim, Y.-G.**, Xu, L., and Zhang, A (2025). A Novel GNN Framework Integrating Neuroimaging and Behavioral Information to Understand Adolescent Psychiatric Disorders. *Medical Imaging with Deep Learning (MIDL)* [[Paper]](https://openreview.net/forum?id=Yjv27GWb3n#discussion) [[Code]](https://github.com/elleryyu/BEG-GAE)
